        ...
        <div class="container-fluid filter-toolbar">            
            <div class="filter-content dropdown">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" style="color: black"href="product.php?filter=all">All product</a>
                    <a class="dropdown-item" style="color: black" href="product.php?filter=blazers">Blazers</a>
                    <a class="dropdown-item" style="color: black" href="product.php?filter=shirts">Shirts</a>
                    <a class="dropdown-item" style="color: black" href="product.php?filter=formalShoes">Formal Shoes</a>
                </div>                
            ...
            while ($row = $productArray->fetch_assoc()) {
                echo "<div class=\"col-3\">
                    <div class=\"product-top\">
                        <img class=\"product-img\" src=\"./image/products/{$row["productImage"]}\">
                        <div class=\"overlay\">
